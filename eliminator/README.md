...
folder. The workflow runs every morning, Thursday evening and every half hour on Sunday during the
...
the site lists each team with the number of entries on it.
